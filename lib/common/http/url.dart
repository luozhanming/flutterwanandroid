...
class WanandroidUrl {
  ...
  //体系文章 GET
  static String systemArtical(int cid, int page) =>
      "https://www.wanandroid.com/article/list/$page/json";

  //作者文章
  static String authorArticals(String name, int page) =>
      "https://wanandroid.com/article/list/$page/json";
  ...
  //项目树
  static const String projectTree =
      "https://www.wanandroid.com/project/tree/json";

  //项目文章
  static String projectArtical(int cid, int page) =>
      "https://www.wanandroid.com/project/list/$page/json?cid=$cid";

  //我的收藏
  static String myCollectionArtical(int page) =>
      "https://www.wanandroid.com/lg/collect/list/$page/json";

  //按照作者昵称搜索文章
  static String searchAuthorArtical(String author, int page) =>
      "/article/list/$page/json?author=$author";

  //收藏文章
  static String collectArtical(int id) =>
      "https://www.wanandroid.com/lg/collect/${id}/json";

  //取消收藏文章
  static String uncollectArtical(int id) =>
